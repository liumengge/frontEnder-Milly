[问题来源](https://github.com/machao/localStorage/)

[模拟实现一个localStorage](https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/166)
...
// 万恶的IE9(9.0.11）)，使用userData也会出现类似session一样的效果，刷新页面后设置的东西就没有了...
