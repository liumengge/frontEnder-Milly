...
那接下来就学习下`tracekit@0.4.6`是如何进行标准化的：
...
- augmentStackTraceWithInitialElement()，在当前错误栈底新增新的错误信息，用于 computeStackTraceByWalkingCallerChain()和第一部分的processLastException()
